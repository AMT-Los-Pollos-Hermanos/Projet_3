...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
    <div class="container">
        <a class="navbar-brand" href="<c:url value="/questions" />">OverFlow</a>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav">
                <li class="nav-item">
                    <a class="nav-link" href="<c:url value="/questions" />">Accueil</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="<c:url value="/" />">Recherche</a>
                </li>
                <li class="nav-item">
